...
|              | --in-allow-leading-zeros |                     | Treat input values with leading zeros as numbers rather than text during CSV parsing. See [Validating Number](validating_number.md).                    |
